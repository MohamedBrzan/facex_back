...
exports.default = (0, AsyncHandler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    job.process[processName].forEach(({ user, resume }, index) => __awaiter(void 0, void 0, void 0, function* () {
        if (user.toString() === targetUserId) {
            job.process[processName].splice(index, 1);
            job.process.rejected.push({ user, resume });
            yield job.save();
        }
    }));
    return res.status(200).json({
        message: `moved job ${job.title} to rejected process successfully`,
        job,
    });
}));
