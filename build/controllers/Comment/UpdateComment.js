...
exports.default = (0, AsyncHandler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!comment)
        return next(new ErrorHandler_1.default(404, `This Comment Id ${commentId} Not Found`));
    comment = yield Comment_1.default.findByIdAndUpdate(commentId, { message, visiblePrivacy }, {
        runValidators: true,
        new: true,
        upsert: true,
    });
